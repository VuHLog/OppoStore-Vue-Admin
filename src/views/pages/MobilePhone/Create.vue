...
async function createMobilePhone() {
  errorMsg.value = "";
  ...
  await proxy.$api
    .post("/api/mobilePhones", mobilePhone.value)
    .then((res) => {
      if (res.message) {
  ...
  <div class="card mt-4">
    ...
    <div class="card-body">
      ...
      <form
        ...
        method="POST"
        @submit.prevent="createMobilePhone"
      >
        <div class="row">
          ...
          <div class="col-md-6 text-start mb-4">
            ...
            <select id="status-text-input" class="form-select">
          ...
          <div class="d-flex flex-wrap col-md-12 mb-4">
            ...
            <div class="text-start text-red" v-if="errorMsgVariant">
              {{ errorMsgVariant }}
            </div>
            <div
